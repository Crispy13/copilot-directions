...
- **Mission isolation.** Only read and write files within the resolved `<mission>` folder and `copilot-office/codebase/`. Never access other mission folders under `copilot-office/missions/`. Each mission is an independent scope.
